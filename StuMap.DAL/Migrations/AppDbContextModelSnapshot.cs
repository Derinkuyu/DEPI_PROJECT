...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StuMap.DAL.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StuMap.DAL.Models.Certificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StuMap.DAL.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StuMap.DAL.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StuMap.DAL.Models.CourseEnrollment", b =>
                {
            ...
            modelBuilder.Entity("StuMap.DAL.Models.CourseRoadmap", b =>
                {
                    ...
                    b.HasKey("CoursesId", "RoadmapId");

                    b.HasIndex("RoadmapId");

                    b.ToTable("CourseRoadmap");
            ...
            modelBuilder.Entity("StuMap.DAL.Models.Material", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StuMap.DAL.Models.MaterialType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StuMap.DAL.Models.Roadmap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StuMap.DAL.Models.RoadmapEnrollment", b =>
                {
                    b.Property<int>("RoadmapId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StuMap.DAL.Models.StudentRoadmapProgress", b =>
                {
                    b.Property<int>("RoadmapId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StuMap.DAL.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StuMap.DAL.Models.ApplicationUser", b =>
                {
                    b.HasOne("StuMap.DAL.Models.Roadmap", null)
                        .WithMany("Students")
            ...
            modelBuilder.Entity("StuMap.DAL.Models.Certificate", b =>
                {
                    b.HasOne("StuMap.DAL.Models.ApplicationUser", "Contributor")
                        .WithMany()
            ...
            modelBuilder.Entity("StuMap.DAL.Models.Contact", b =>
                {
                    b.HasOne("StuMap.DAL.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StuMap.DAL.Models.CourseEnrollment", b =>
                {
                    b.HasOne("StuMap.DAL.Models.Course", "Course")
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StuMap.DAL.Models.ApplicationUser", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("StuMap.DAL.Models.CourseRoadmap", b =>
                {
                    b.HasOne("StuMap.DAL.Models.Course", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StuMap.DAL.Models.Material", b =>
                {
                    ...
                    b.HasOne("StuMap.DAL.Models.MaterialType", "MaterialType")
                        .WithMany("Materials")
            ...
            modelBuilder.Entity("StuMap.DAL.Models.Roadmap", b =>
                {
                    ...
                    b.HasOne("StuMap.DAL.Models.Specialization", "Specialization")
                        .WithMany("Roadmaps")
            ...
            modelBuilder.Entity("StuMap.DAL.Models.RoadmapEnrollment", b =>
                {
                    b.HasOne("StuMap.DAL.Models.Roadmap", "Roadmap")
            ...
            modelBuilder.Entity("StuMap.DAL.Models.StudentRoadmapProgress", b =>
                {
                    ...
                    b.HasOne("StuMap.DAL.Models.RoadmapEnrollment", null)
                        .WithMany("StudentRoadmapProgress")
